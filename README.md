...
2026-09-11 启动 Windows 可安装测试版工作：新增内置 Python 运行时构建器、当前用户安装脚本及桌面启动窗口，复用本地工作台，论文数据与程序目录分离。当前正在验证实际安装包，尚未作为公开下载版发布；见[Windows测试版安装与构建](docs/Windows测试版安装与构建.md)。
