...
2026-09-11 Windows 可安装测试版已构建并完成临时目录实装验收：安装器约595MiB，内置 Python 3.13、CPU PyTorch 与本地检索依赖；安装后能在无源码目录的情况下启动本地 API/工作台，关闭窗口后服务正常回收。即将作为 GitHub 预发布版本提供 Windows x64 下载；当前未做代码签名，首次下载可能看到 Windows 信誉提示。见[Windows测试版安装与构建](docs/Windows测试版安装与构建.md)。
